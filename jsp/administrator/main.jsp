...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/administrator/main.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/administrator/public-style.css">
    <script src="${pageContext.request.contextPath}/js/jquery-2.2.1.min.js"></script>
     <script src="${pageContext.request.contextPath}/js/jquery.cookie.js"></script>
    <script src="${pageContext.request.contextPath}/bootstrap/js/bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/js/public.js"></script>
    <script src="${pageContext.request.contextPath}/js/administrator/main.js"></script>
</head>
<body>
...
<div class="second-nav">
    <ul class="container">
            <ul class="nav navbar-nav">
                ...
                <li class="add-new"><a href="javascript:void(0)">添加商品</a></li>
            </ul>
    </ul>
</div>
...
<div class="separate"></div>
    <h3>今日推荐&nbsp&nbsp<small>今天向买家们推荐的商品</small></h3>
...
<div class="container near">
    <hr>
    <div class="separate"></div>
    <h3>近期热卖&nbsp&nbsp<small>近期最受欢迎商品</small></h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="input-group">
                    <span class="input-group-addon addon">商品名称</span>
                    <input type="text" class="form-control rec_name input" placeholder="">
                    <span class="warning"><h6></h6></span>
                </div><!-- /input-group -->
                <div class="separate"></div>
                <div class="input-group">
                    <span class="input-group-addon addon">商品价格</span>
                    <input type="text" class="form-control rec_price input" placeholder="">
                    <span class="warning"><h6></h6></span>
                </div><!-- /input-group -->
            </div>
            ...
            <div class="modal-body">
                <form>
  					<div class="form-group">
   					 	<label>商品名</label>
   					    <input type="text" class="form-control add-name">
  					</div>
  					<div class="form-group">
                        <label>市场价格</label>
                        <input type="text" class="form-control add-marketprice">
                   </div>
 		   		   <div class="form-group">
                        <label>本店价格</label>
                        <input type="text" class="form-control add-price">
                   </div>
                   <div class="form-group">
                        <label>添加描述</label>
                        <textarea class="form-control add-describe" rows="3"></textarea>
                   </div>
                   <div class="form-group">
                        <label>选择一级分类</label>
                   ...
                   <div class="form-group">
                        <label>上传图片</label>
                        <input type="file" id="InputFile" accept=".jpg" >
                   </div>
                </form>
            </div>
            <div class="modal-footer">
